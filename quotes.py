cliche= [
        ...
        "The important thing is not to stop questioning.\nCuriosity has its own reason for existence.\nOne cannot help but be in awe when he contemplates the mysteries of/n eternity, of life, of the marvelous structure of reality.\n-Albert Einstein.",
...
funny = [
        "If I don't have some cake soon, I might die.\n-Stanley Hudson, The Office Season 4, 'Survivor Man'",
        "Identity theft is not a joke, Jim! Millions of families suffer every year.\n-Dwight Schrute, The Office Season 3, 'Product Recall'",
        "I am running away from my responsibilities. And it feels good.\n-Michael Scott, The Office Season 4, 'Money'",
        "And I knew exactly what to do. But in a much more real sense, I had no idea what to do.\n-Michael Scott, The Office Season 5, 'Stress Relief'",
        "I just want to lie on the beach and eat hot dogs.\nThat's all I've ever wanted.\n-Kevin Malone, The Office Season 3, 'Beach Games'",
        "I just wanna get drunk and eat chicken fingers.\n-Trailer Park Boys. Season 1, Episode 2",
...
casual = ["Yoooo you gotta ", 'ight time to ', "Bro don't forget to ", 'yeeerrrooo' ]
motivate = ['You got this! Time to ', 'Rise and Grind. Time to ']
normal = ['Make sure to ', "Hey, don't forget to ", "It's time to ", "I'd like to remind you to ", "I hope you haven't forgotten to ", "May I remind you to ", "Friendly reminder to "]